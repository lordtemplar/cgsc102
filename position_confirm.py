...
# Check JSON2 credentials
client_json2, external_position_sheet = check_credential_and_connection('positionselection-d40f2d782b2d.json', 
                                                                       'https://docs.google.com/spreadsheets/d/1N9YSyQ19Gi5roZfgbuo_Bh78CEDHRiVY/edit?usp=sharing&ouid=108880626923731848508&rtpof=true&sd=true')
